...
#
# Usage:   curl -fsSL https://newapi.email/i.sh | bash
# Local:   MOBILEAI_BASE=http://127.0.0.1:8443/client bash i.sh   (dev/test)
#
...
BASE="${1:-${MOBILEAI_BASE:-https://newapi.email/client}}"
